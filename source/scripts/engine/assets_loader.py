...
def load_assets():
    """Load all audio and image assets needed by the gameplay loop."""
    # Keep click sounds in a list so the game can randomize feedback variety.
    ...
    # Display metadata is configured here so setup runs once at startup.
